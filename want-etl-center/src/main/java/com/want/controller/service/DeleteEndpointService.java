/**
 * -------------------------------------------------------
 * @FileName：DeleteEndpointService.java
 ...
 */
@Service
public class DeleteEndpointService extends ResponseService<String, String> {
	@Autowired
	...
	protected Void dataAccess(InputArgumentDTO argument, String parameters) throws Exception {
		settingService.deleteJDBCServer(parameters);
		settingService.deleteJCOServer(parameters);
		return null;
	}
