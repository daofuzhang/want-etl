/**
 * -------------------------------------------------------
 * @FileName：DeleteMailGroupService.java
 ...
 */
@Service
public class DeleteMailGroupService extends ResponseService<String, String> {
	@Autowired
	...
	protected Void dataAccess(InputArgumentDTO argument, String parameters) throws Exception {
		settingService.deleteMailGroup(parameters);
		return null;
	}
